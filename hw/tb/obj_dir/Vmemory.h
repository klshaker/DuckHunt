...
VL_MODULE(Vmemory) {
  public:
    ...
    VL_SIG16(memory__DOT__mem[16],15,0);
...
#endif // VL_DEBUG
  public:
    static void _eval_initial(Vmemory__Syms* __restrict vlSymsp);
    static void _eval_settle(Vmemory__Syms* __restrict vlSymsp);
    ...
    static void traceFullThis(Vmemory__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code);
    static void traceFullThis__1(Vmemory__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code);
    static void traceInitThis(Vmemory__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code);
    static void traceInitThis__1(Vmemory__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code);
